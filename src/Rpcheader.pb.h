...
// bytes server_name = 1;
inline void Header::clear_server_name() {
  server_name_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline const std::string& Header::server_name() const {
  // @@protoc_insertion_point(field_get:myrpc.Header.server_name)
  return _internal_server_name();
}
inline void Header::set_server_name(const std::string& value) {
  _internal_set_server_name(value);
  // @@protoc_insertion_point(field_set:myrpc.Header.server_name)
}
inline std::string* Header::mutable_server_name() {
  // @@protoc_insertion_point(field_mutable:myrpc.Header.server_name)
  return _internal_mutable_server_name();
}
inline const std::string& Header::_internal_server_name() const {
  return server_name_.Get();
}
inline void Header::_internal_set_server_name(const std::string& value) {
  
  server_name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
inline void Header::set_server_name(std::string&& value) {
  
  server_name_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:myrpc.Header.server_name)
}
inline void Header::set_server_name(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  server_name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:myrpc.Header.server_name)
}
inline void Header::set_server_name(const void* value,
    size_t size) {
  
  server_name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:myrpc.Header.server_name)
}
inline std::string* Header::_internal_mutable_server_name() {
  
  return server_name_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* Header::release_server_name() {
  // @@protoc_insertion_point(field_release:myrpc.Header.server_name)
  return server_name_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void Header::set_allocated_server_name(std::string* server_name) {
  ...
  server_name_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), server_name,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:myrpc.Header.server_name)
}
inline std::string* Header::unsafe_arena_release_server_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:myrpc.Header.server_name)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return server_name_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void Header::unsafe_arena_set_allocated_server_name(
    std::string* server_name) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (server_name != nullptr) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:myrpc.Header.server_name)
}
...
inline void Header::set_method_name(std::string&& value) {
  ...
  method_name_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:myrpc.Header.method_name)
}
inline void Header::set_method_name(const char* value) {
  ...
  method_name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:myrpc.Header.method_name)
}
inline void Header::set_method_name(const void* value,
  ...
  method_name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:myrpc.Header.method_name)
}
...
inline std::string* Header::unsafe_arena_release_method_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:myrpc.Header.method_name)
  GOOGLE_DCHECK(GetArena() != nullptr);
...
inline void Header::unsafe_arena_set_allocated_method_name(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:myrpc.Header.method_name)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 Header::args_size() const {
  // @@protoc_insertion_point(field_get:myrpc.Header.args_size)
...
inline void Header::set_args_size(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:myrpc.Header.args_size)
}
