...
static void InitDefaultsscc_info_Header_Rpcheader_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::myrpc::_Header_default_instance_;
    new (ptr) ::myrpc::Header();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::myrpc::Header::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Header_Rpcheader_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_Header_Rpcheader_2eproto}, {}};
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_Rpcheader_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::myrpc::Header, server_name_),
  PROTOBUF_FIELD_OFFSET(::myrpc::Header, method_name_),
  PROTOBUF_FIELD_OFFSET(::myrpc::Header, args_size_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::myrpc::Header)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::myrpc::_Header_default_instance_),
};

const char descriptor_table_protodef_Rpcheader_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\017Rpcheader.proto\022\005myrpc\"E\n\006Header\022\023\n\013se"
  "rver_name\030\001 \001(\014\022\023\n\013method_name\030\002 \001(\014\022\021\n\t"
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_Rpcheader_2eproto_sccs[1] = {
  &scc_info_Header_Rpcheader_2eproto.base,
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_Rpcheader_2eproto = {
  false, false, descriptor_table_protodef_Rpcheader_2eproto, "Rpcheader.proto", 103,
...
void Header::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_Header_Rpcheader_2eproto.base);
  server_name_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  method_name_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  args_size_ = 0u;
}
...
// @@protoc_insertion_point(generalized_merge_from_start:myrpc.Header)
  GOOGLE_DCHECK_NE(&from, this);
  const Header* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<Header>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:myrpc.Header)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:myrpc.Header)
    MergeFrom(*source);
  }
}
...
// @@protoc_insertion_point(generalized_copy_from_start:myrpc.Header)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::myrpc::Header* Arena::CreateMaybeMessage< ::myrpc::Header >(Arena* arena) {
